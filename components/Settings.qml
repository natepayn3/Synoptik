        ...
        RowLayout {
            ...
            ClippingRectangle {
                ...
                Item {
                    ...
                    Loader { anchors.fill: parent; active: settingsRoot.activeSection === 11; visible: active; sourceComponent: ShellSettings {} }

                    Loader { anchors.fill: parent; active: settingsRoot.activeSection === 12; visible: active; sourceComponent: IconSettings {} }
                    Loader { anchors.fill: parent; active: settingsRoot.activeSection === 13; visible: active; sourceComponent: SoundSettings {} }
