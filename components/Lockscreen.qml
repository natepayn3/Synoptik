    ...
    WlSessionLock {
        ...
        surface: Component {
            WlSessionLockSurface {
                ...
                // 2. TOP STATUS BAR (Battery, Wi-Fi, Time, Host)
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        // Left: Battery & Network Indicators
                        RowLayout {
                            spacing: 16
                            ...
                            RowLayout {
                                ...
                                Text {
                                    text: (lockscreenScope.shellRef && lockscreenScope.shellRef.wifiPowered && lockscreenScope.shellRef.wifiSsid !== "") ? "wifi" : "wifi_off"
                                    font.family: "Material Symbols Outlined"
                                    font.pixelSize: 18
                                    color: (lockscreenScope.shellRef && lockscreenScope.shellRef.wifiPowered && lockscreenScope.shellRef.wifiSsid !== "") ? Config.accent : Config.textMuted
                                }

                                Text {
                                    text: (lockscreenScope.shellRef && lockscreenScope.shellRef.wifiSsid !== "") ? lockscreenScope.shellRef.wifiSsid : ((lockscreenScope.shellRef && lockscreenScope.shellRef.wifiPowered) ? "Connected" : "Disconnected")
